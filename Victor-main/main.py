...
from Victor import calculator, wishMe, tellTime, reply, weather, todayNews
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # take image
        elif ("take" in input_from_user) and (("image" in input_from_user) or (
                "photo" in input_from_user) or "picture" in input_from_user or "snapshot" in input_from_user):
            start_camera()
            continue
        ...
        elif ("calculator" in input_from_user) or ("calculation" in input_from_user) or (
                "calculations" in input_from_user):
            calculator()
            continue
